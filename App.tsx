              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-2xl font-black text-purple-900 tracking-tight flex items-center justify-between dark:text-white">
                    8923366501
                    <button onClick={() => {navigator.clipboard.writeText('8923366501'); alert('Copied!');}} className="text-[10px] bg-purple-200 text-purple-700 px-3 py-1 rounded-lg font-bold dark:bg-purple-900 dark:text-purple-200">COPY</button>
                  </p>
                </div>
                <div>
                  <p className="text-[10px] text-purple-400 font-bold uppercase mb-1">Account Name</p>
                  <p className="text-lg font-bold text-purple-900 uppercase dark:text-white">John Goodness</p>
                </div>
                <div>
